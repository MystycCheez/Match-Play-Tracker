...
#define KEY_LIST \
    ...
    KEY(K_CTRL_R, KEY_RIGHT_CONTROL, "R CTRL") \
    KEY(K_CTRL_L, KEY_LEFT_CONTROL, "L CTRL") \
    KEY(K_SHIFT_R, KEY_RIGHT_SHIFT, "R SHIFT") \
    KEY(K_SHIFT_L, KEY_LEFT_SHIFT, "L SHIFT") \
    KEY(K_ALT_R, KEY_RIGHT_ALT, "R ALT") \
    KEY(K_ALT_L, KEY_LEFT_ALT, "L ALT") \
    KEY(K_A, KEY_A, "A") \
    KEY(K_C, KEY_C, "C") \
    KEY(K_D, KEY_D, "D") \
    KEY(K_X, KEY_X, "X") \
